...
```{r fig.height=8, fig.width=8}
save_ggplot_formats(PCAplot_vst,
                    plots_folder,
                    "PCA_timepoints",
                    width = 8,
                    height = 8)
...
biplot_theme <- list(theme(axis.title = element_text(size = 25),
                          axis.text = element_text(size = 25),
